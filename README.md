## Overview
This is a simple SwiftUI app that fetches and displays a list of books from the Open Library API. It supports offline caching and error handling using MVVM with a repository for managing data. No third party dependencies are used.
